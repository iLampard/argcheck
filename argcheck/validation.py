...
# Ref: https://github.com/quantopian/zipline/blob/master/zipline/utils/input_validation.py
...
def getattrs(value, attrs, default=None):
    """
...
def optional(*type_):
    ...
    """
    return tuple(type_) + tuple([type(None)])
