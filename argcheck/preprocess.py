...
# Ref: https://github.com/quantopian/zipline/blob/master/zipline/utils/preprocess.py
...
def _build_preprocessed_function(func,
    ...
    _new_code_argorder = [[arg_] for arg_ in _code_argorder]
    new_func.__code__ = CodeType(*map(partial(get_in, coll=args), _new_code_argorder))
